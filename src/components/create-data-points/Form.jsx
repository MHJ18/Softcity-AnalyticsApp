      ...
      <div className="form-container m-3 p-3">
        <form onSubmit={formsubmit}>
          ...
          <div className="mb-4">
            ...
            >
              <option className="options" value={des} name="Text Field">
                Text field
              </option>
          ...
          {state.allow && <IoMdAddCircle onClick={add1} className="addicons" />}
          {state.allow &&
          ...
          <div className="d-flex justify-content-between align-items-center buttons-style">
            <div>
              {state.allow && (
                <IoMdAddCircle onClick={add2} className="addicons last-icon" />
              )}
            </div>
            <div>
              <button
