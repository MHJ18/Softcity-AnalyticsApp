...
function DataPoints() {
    const dataPointsRgd = [ 
        {sno:"1",template:"name of template",charts:"23",datagroup:"122",assigneduser:"42542",collection:"32",created:"mamilaila"},
        {sno:"1",template:"name of template",charts:"23",datagroup:"122",assigneduser:"42542",collection:"32",created:"mamilaila"},
        {sno:"1",template:"name of template",charts:"23",datagroup:"122",assigneduser:"42542",collection:"32",created:"mamilaila"},
        {sno:"1",template:"name of template",charts:"23",datagroup:"122",assigneduser:"42542",collection:"32",created:"mamilaila"},
        {sno:"1",template:"name of template",charts:"23",datagroup:"122",assigneduser:"42542",collection:"32",created:"mamilaila"},
          ...
          <Card className='border-0'>
            <Card.Body>
              <Row className='align-items-center mb-4'>
                <Col md={6}>
                  <Card.Title className='mb-0'>User Assigned (Template Name)</Card.Title>
                </Col>
                <Col md={6}>
                    <div className='d-flex align-items-center justify-content-end'>
                      <span>Total Users:390</span>
                      <Button className='btn-theme ms-3' type="button">Back to Template</Button>
                    </div>
                </Col>
              </Row>
                        ...
                        dataPointsRgd.map((data,index)=>( 
                            <tr key={index} style={{border:"solid 1px grey"}}>
                                ...
                                <td style={{textAlign:"end"}}>
                                  <XCircleFill className='text-danger ms-2'  onClick={handleShow}/>
                                </td>
                            </tr>
                        ))
                    }
              ...
              <div className='d-flex justify-content-between'>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul className="pagination justify-content-end mb-0 pagination-sm">
                            <li className="page-item"><Link className="page-link"><ArrowLeft/></Link></li>
                            <li className="page-item"><Link className="page-link">1</Link></li>
                            <li className="page-item active"><Link className="page-link">2</Link></li>
                            <li className="page-item"><Link className="page-link">3</Link></li>
                            <li className="page-item"><Link className="page-link">...</Link></li>
                            <li className="page-item"><Link className="page-link">20</Link></li>
                            <li className="page-item"><Link className="page-link"><ArrowRight/></Link></li>
                        </ul>
                    </nav>
                </div>
            </Card.Footer>
        ...
        <Modal show={show} onHide={handleClose} size="sm" centered>
          ...
          <Modal.Body>
            <div className='text-center'>
              ...
              <hr className='mx-auto' style={{width:"30px", borderTop:"3px solid #14365d",opacity:"1", borderRadius:"5px"}}/>
            </div>
          </Modal.Body>
